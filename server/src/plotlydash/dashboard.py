...
def init_dashboard(server):
    ...
    # create a Dash object with the server as the server passed in from __init__.py
    # and the route to this section of the app as /dashapp/
    dash_app = dash.Dash(
        server=server,
    ...
    init_callbacks(dash_app, heatmaps, trends, curr_team)

    return dash_app.server

def init_callbacks(dash_app, heatmaps, trends, curr_team):
